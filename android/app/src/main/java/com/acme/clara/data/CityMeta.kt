...
object CityMeta {
    val all: Map<String, CityInfo> = listOf(
        ...
        CityInfo("Cairo", "Africa", "the Pyramids",
            "Cairo, located where the Nile River fans out into its broad delta, is the largest metropolitan area in Africa.", false, "city_cairo", greeting = "In Arabic, hello is “Salaam” (sah-LAAM).", flag = "red, white and black bands with a golden eagle", currency = "the Egyptian pound"),
        ...
        CityInfo("Kathmandu", "Asia", "the Himalayas",
            "Nepal was closed to the outside world for centuries, but can now be reached by plane and road from India and Tibet.", false, "city_kathmandu", greeting = "In Nepali, a greeting is “Namaste” (nah-mah-STAY).", flag = "a crimson double-pennant shape with a white moon and sun", currency = "the Nepalese rupee"),
        ...
        CityInfo("Beijing", "Asia", "the Great Wall",
            "Beijing is the capital of the People's Republic of China. One of this nation's most famous landmarks is the Great Wall.", false, "city_peking", greeting = "In Mandarin, hello is “Nǐ hǎo” (nee how).", flag = "red with one large yellow star and four smaller stars", currency = "the yuan"),
        ...
        CityInfo("Rio de Janeiro", "South America", "Christ the Redeemer",
            "Brazil's capital is Brasilia, a planned city built from scratch in the country's interior in the 1960s.", false, "city_rio_de_janeiro", greeting = "In Portuguese, a casual hi is “Oi” (oy).", flag = "green with a yellow diamond and a blue globe crossed by a starry band", currency = "the real"),
        ...
        CityInfo("Singapore", "Asia", "the tip of the Malay Peninsula",
            "The nation of Singapore, located near the equator in Southeast Asia, consists of one large island plus about 60 smaller ones.", false, "city_singapore", greeting = "In Malay, “Apa khabar?” (AH-pah KAH-bar) means “how are you?”.", flag = "red above white with a white crescent moon and five stars", currency = "the Singapore dollar"),
