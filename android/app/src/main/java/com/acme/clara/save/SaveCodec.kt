...
object SaveCodec {
    ...
    private fun stateMap(s: GameState): Map<String, Any?> = linkedMapOf(
        ...
        "clock" to s.clock,
        "caseDeadlineHours" to s.caseDeadlineHours,
        ...
        "bureauTipUsed" to s.bureauTipUsed,
        ...
        "visitedPlaces" to s.visitedPlaces.toList(),
        "warmUpNextCase" to s.warmUpNextCase,
        "streakDays" to s.streakDays,
        "streakFreezes" to s.streakFreezes,
        "lastSolveEpochDay" to s.lastSolveEpochDay,
        "cityLastSeen" to s.cityLastSeen.map { "${it.key}\u001F${it.value}" },
    ...
    private fun readState(m: Map<*, *>): GameState {
        ...
        return GameState(
            ...
            bureauTipUsed = bool(m["bureauTipUsed"], false),
