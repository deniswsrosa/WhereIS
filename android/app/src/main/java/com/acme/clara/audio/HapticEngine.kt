...
object HapticEngine {
    ...
    // Only ever called from the SDK_INT >= O branch in play(); the annotation documents that
    // contract for lint (which can't see across the call boundary) without changing behaviour.
